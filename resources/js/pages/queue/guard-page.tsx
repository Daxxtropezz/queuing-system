          ...
          <CardContent className="pb-10">
            <form className="space-y-8">
              ...
              <div className="flex flex-col items-center gap-6 mb-10">
                ...
                <div className="flex gap-6">
                  <Button
                    type="button"
                    size="lg"
                    className={`h-20 w-40 text-xl font-bold rounded-2xl ${data.ispriority === 0
                  ...
                  <Button
                    type="button"
                    size="lg"
                    className={`h-20 w-40 text-xl font-bold rounded-2xl ${data.ispriority === 1
              ...
              {data.ispriority === 0 || data.ispriority === 1 ? (
                <>
                  <p className="text-lg font-semibold text-slate-200 text-center mb-4">
                    Step 2: Select Your Transaction
                  </p>
                    ...
                    {transactionTypes.map((opt: any) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="text-center text-lg leading-snug font-semibold md:text-xl">
                            {opt.name}
                          </span>
                          {opt.description && (
                ...
                <p className="text-center text-slate-400 italic mt-6">
                  Please select Regular or Priority first.
                </p>
              )}
            </form>
          </CardContent>
