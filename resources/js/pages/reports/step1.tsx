...
export default function Step1() {
    ...
    const onFilterChange = (name: string, value: any) => {
        router.get(route("reports.step1"), { ...filters, [name]: value }, { preserveState: true, replace: true });
    };
        ...
        <>
            ...
            <AppLayout>
                <div className="p-8">
                    ...
                    <ServiceTimeChart step1Data={doneTickets} step2Data={[]} />
                    <CompletedTransactionsTable grouped={grouped} step={1} />

                    <Pagination
                        pagination={tickets}
                        filters={filters}
                        baseUrl={route("reports.step1")}
                        isLoading={isLoading}
                    />
